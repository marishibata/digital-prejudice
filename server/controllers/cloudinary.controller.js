...
// as I'm not familiar with cloudinary and anything outside of boilerplate backend, I tried to find some kind of solution to study from.
// found this after browsing but I need to modify it, still don't fully understand it
cloudinary.config({
